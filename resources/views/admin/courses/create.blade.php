...
<div class="fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold mb-0">
            <i class="bi bi-plus-circle text-warning me-2"></i>Nuevo Curso
        </h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="{{ route($routePrefix . 'courses.store') }}">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('section') is-invalid @enderror" id="section" name="section">
                            ...
                            @foreach(range('A', 'E') as $letra)
                                <option value="{{ $letra }}" @selected(old('section') == $letra)>{{ $letra }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('academic_year') is-invalid @enderror" id="academic_year" name="academic_year" value="{{ old('academic_year', date('Y') . '-' . (date('Y')+1)) }}">
