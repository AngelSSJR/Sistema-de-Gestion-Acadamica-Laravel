...
<div class="fade-in">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold mb-0">
            <i class="bi bi-pencil-square text-warning me-2"></i>Editar Profesor
        </h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('dev-admin.teachers.update', $teacher) }}">
                @csrf @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('employee_code') is-invalid @enderror" id="employee_code" name="employee_code" value="{{ old('employee_code', $teacher->employee_code) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('education_level') is-invalid @enderror" id="education_level" name="education_level">
                            ...
                            @foreach(['Licenciatura', 'Especialización', 'Maestría', 'Doctorado'] as $level)
                                <option value="{{ $level }}" @selected(old('education_level', $teacher->education_level) == $level)>{{ $level }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('hire_date') is-invalid @enderror" id="hire_date" name="hire_date" value="{{ old('hire_date', $teacher->hire_date?->format('Y-m-d')) }}">
